...
1. **Receive plan content**: If plan content was provided inline with the invocation, use it directly. Otherwise, If uncertain, note assumptions in the spec and proceed. List any ambiguities for the user to review: "Please paste your plan below."
...
5. **Generate spec files using faithful mapping**:
   ...
   **implementation.md**: Write the file at with template headers only (empty — populated incrementally during Phase 3).
